...
public class calendario extends JFrame implements ActionListener{
	...
	public boolean bisiesto(int a) { // Retorna true si el a�o es bisiesto, de lo contrario retorna false
	...
	public void escogerMes() { // Establece la interfaz y muestra en la tabla el mes seleccionado por el usuario
		...
		try {
			...
			JOptionPane.showMessageDialog(null,e3,"Seleccion",JOptionPane.QUESTION_MESSAGE);
			...
			"Debe digitar numeros enteros positivos en el espacio para el anio","Error",
	...
	public void opcionRecordatorio() { // Muestra la interfaz para la opcion "Recordatorio"
		...
		if(columnaSeleccionada != -1 && filaSeleccionada != -1) {
			...
			JOptionPane.showMessageDialog(null,
			"Debe seleccionar una celda que no esta vacia","Error",
			JOptionPane.WARNING_MESSAGE);
				...
				JOptionPane.showMessageDialog(null,o1,"Seleccion",JOptionPane.QUESTION_MESSAGE);
	...
	public void verRecordatorio() { // Lee desde los archivos con recordatorios y extrae su informacion
		...
		try {
			...
			"para el "+identificarDato(datoSeleccionado)+" de "+meses[mesTemporal].toLowerCase()+" del a�o "+anoTemporal,
